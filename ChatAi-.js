...
class ChatAI {
    ...
    constructor(options) {
        let defaults = {
            api_key: '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',
            source: 'openai',
            model: 'gpt-3.5-turbo',
            conversations: [],
    ...
    getMessage() {
        ...
        fetch('https://api.openai.com/v1/chat/completions', {
            ...
            method: 'POST',
            headers: {
                'Authorization': 'Bearer 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',
    ...
    openSettingsModal() {
        ...
        return this.modal({
            ...
            modalTemplate: function () {
                // Get the account email from localStorage
                let accountEmail = localStorage.getItem('signupEmail') || 'N/A';
                ...
                <div class="chat-ai-modal">
                    <div class="content">
                        ...
                        <form>
                            ...
                            <input type="text" id="accountEmail" value="${accountEmail}" disabled><br><br>
                            <!-- Other settings inputs go here -->
                        </form>
                    </div>
                </div>
                `;
        ...
        return `
            <div class="welcome">
                ...
                <div class="suggestions">
                    ...
                    <a href="tel:112" class="suggestion">
